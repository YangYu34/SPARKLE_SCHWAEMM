...
def SCHWAEMM_256_128(eng, M_value, Key, Nonce, Auth_value, len):
    # carry bit
...
SCHWAEMM_256_128(eng, 0x03020100, 0x0F0E0D0C0B0A09080706050403020100,
                 0x1F1E1D1C1B1A191817161514131211100F0E0D0C0B0A09080706050403020100, 0x03020100, 32)
eng.flush()
